...
hicue extract test_out/SecB_pileups test_data/positions/SRP_dd_genes.bed test_data/others/banks.txt --windows 50000,100000 --circulars NC_014500.1 --detrending patch --flip -t 8 --no-loci --no-batch --display_strand 
