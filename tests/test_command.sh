...
hicue regions test_out/regions_test_ps test_data/regions/3D7_only_chrom7.bed test_data/regions/MicroC-Bartfai-Control.mcool::resolutions/5000 --loops --separate_by chroms --windows 100000 --padding 1.0 --no-batch --no-loci --diag_mask 30000 --format png,pdf --save_tmp --detrending ps -e 20,51 #--cmap_limits -0.2 0.2
# hicue regions test_out/regions_test_patch test_data/regions/3D7_only_chrom7.bed test_data/regions/MicroC-Bartfai-Control.mcool::resolutions/5000 --loops --separate_by chroms --windows 100000 --padding 1.0 --nb_pos 10 --no-batch --no-loci --format png,pdf --save_tmp --detrending patch -e 20,51 #--cmap_limits -0.2 0.2
# hicue regions test_out/regions_test_none test_data/regions/3D7_only_chrom7.bed test_data/regions/MicroC-Bartfai-Control.mcool::resolutions/5000 --loops --separate_by chroms --windows 100000 --padding 1.0 --nb_pos 10 --no-batch --no-loci --format png,pdf --save_tmp --detrending none -e 20,21,51,50,49,52,60 # --cmap_limits -0.2 0.2