...
hicue extract test_out/cool_files_test test_data/positions/SRP_dd_genes.bed test_data/others/banks.txt --windows 100000 --detrending patch --flip -t 8 --save_tmp --no-loci --batch --display_strand