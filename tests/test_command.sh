...
hicue extract test_out/human test_data/positions/some_human_genes.bed test_data/matrices/human_PL69.mcool::resolutions/1000 --windows 100000 --detrending patch --flip -t 8 --save_tmp --no-loci --batch --display_strand